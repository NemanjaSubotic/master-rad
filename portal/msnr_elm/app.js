...
var $author$project$Main$StudentPage = {$: 'StudentPage'};
var $author$project$User$Login$Model = F2(
	function (email, password) {
		return {email: email, password: password};
	});
var $author$project$User$Login$initialModel = A2($author$project$User$Login$Model, '', '');
...
var $author$project$Main$StudentRoute = {$: 'StudentRoute'};
...
var $author$project$Main$parser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Main$StudentRoute,
			...
			switch (_v0.a.$) {
				...
				case 'StudentRoute':
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{page: $author$project$Main$StudentPage}),
						cmd);
				default:
					var _v3 = _v0.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$LoginPage($author$project$User$Login$initialModel)
							}),
						cmd);
			}
		} else {
...
var $author$project$Main$toLogin = F2(
	function (model, _v0) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					page: $author$project$Main$LoginPage(loginModel)
				}),
...
var $author$project$User$Session$GotLoginResult = function (a) {
	return {$: 'GotLoginResult', a: a};
};
...
var $author$project$User$Login$createBody = function (model) {
...
var $author$project$User$Login$loginPost = function (model) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				return _Utils_Tuple2(
					model,
					$author$project$User$Login$loginPost(model));
		}
	});
...
var $author$project$Util$viewInput = F5(
	function (t, c, p, v, toMsg) {
		return A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Util$viewInput, 'email', 'form-control', 'Email', model.email, $author$project$User$Login$Email)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A5($author$project$Util$viewInput, 'password', 'form-control', 'Lozinka', model.password, $author$project$User$Login$Password)
					])),
				A2(
...
var $author$project$Main$view = function (model) {
	var content = function () {
		...
		switch (_v0.$) {
			...
			case 'ProfesorPage':
				return $elm$html$Html$text('Profesor');
			case 'AdminPage':
