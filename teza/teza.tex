...
\begin{listing}[h]
  ...
  \end{minted}
  \caption{Primeri kreiranje \emph{HTML} čvorova}
...
\emph{OTP} je skraćenica za \emph{Open Telecom Platform}, što je donekle pogrešan naziv za ovaj razvojno
...
čini lakom. Sa druge strane, rad sa programskim jezikom \emph{Elm} sa svojstvenom \emph{Elm}
